...
def recorre_laberinto(laberinto):
    ...
    while fila < n - 1 or columna < n - 1:         #continúe mientras las coordenadas fila y columna estén dentro de los limites del laberinto.
        if (len(movimientos) == 0 or movimientos[-1] != 'Arriba') and fila + 1 < n and laberinto[fila + 1][columna] != 'X':
            ...
            # se rompe el ciclo while con break.
...
# la matriz
dimension = 5
# funcion una vez establecidos los valores de obstaculos
